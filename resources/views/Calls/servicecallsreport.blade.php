...
<body>
<form class="form" method="post" name="calReport" action="{{route('serviceReport')}}">
{{csrf_field()}}
<div class="topnav">
 ...
 <a class="active" href="{{route('service')}}">Service Report</a>
...
<div class ="container mt-5">
      <div classs="form-group">
        <h3 align="center"> SERVICE CALL REPORT </h3>
