...
.topnav {
  background-color: #306EFF;/*#1569C7,#151B54 */
  overflow: hidden;
}
.topnav a {
  float: left;
...
.topnav a.active {
  background-color: #033E3E;/*#04AA6D;*/
  color: white;
}
.container {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
            max-width: 1900px;
...
<body>
<form class="form" method="post" name="calReport" action="{{route('tdlReport')}}">
{{csrf_field()}}
<div class="topnav">
 ...
 <a class="active" href="{{route('tdl')}}">TDL Report</a>
...
<div class ="container mt-5">
      <div classs="form-group">
        <h3 align="center"> TDL CALLS REPORT </h3>
        ...
        <label>Customer Name</label><input type="text" id="customer" name="search" placeholder="Search" class="form-control" value="" />
     ...
     <label>Customer Phone No</label><input type="text" id="phone" name="search" placeholder="Search" class="form-control" value="" />
