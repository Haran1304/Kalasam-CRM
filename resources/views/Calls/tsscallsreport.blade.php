...
<body>
<form class="form" method="post" name="TssReport" action="{{route('tssReport')}}">
{{csrf_field()}}
<div class="topnav">
 ...
 <a class="active" href="{{route('tss')}}">TSS Report</a>
 <a href="{{route('addcust')}}">Add Customer</a>
 <a href="{{route('logout')}}">LogOut</a>
</div>
<div class ="container mt-5">
      <div classs="form-group">
        <h3 align="center"> TSS CALL REPORT </h3>
